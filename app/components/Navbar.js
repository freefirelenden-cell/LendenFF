                ...
                <div className="flex gap-2">
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            className="md:hidden text-[var(--color-hover)] focus:outline-none"
                        >
                            ...
                            <SignedOut>
                                <SignInButton mode="modal">
                                    <button
                                        ...
                                        className=" rounded-full font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 hover:opacity-90 transition"
                                    >
                                        Sign In
                                    </button>
                                </SignInButton>
