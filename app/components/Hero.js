...
export default function Hero() {
  return (
    <section className="relative text-center py-32 px-4 overflow-hidden shadow-xl bg-[var(--color-bg)] transition-colors duration-300">
      {/* Subtle radial glow behind text (gold aura) */}
      ...
      <div className="relative z-10">
        <h1 className="text-4xl md:text-5xl font-extrabold text-[var(--color-accent-yellow)] mb-6">
          Trusted Free Fire Accounts
        </h1>

        <p className="text-[var(--color-text-secondary)] max-w-xl mx-auto mb-8 text-sm md:text-base leading-relaxed">
          100% Gmail-verified & safe transfers. Buy ranked Free Fire accounts
          with confidence — secure, affordable, and instant delivery.
        </p>
        ...
        <p className="text-xs text-[var(--color-accent-blue)] mt-4 italic">
          Verified sellers • Secure Gmail transfer • Instant access
        </p>
      </div>
    </section>
  );
